...
// --- Shield Artifact Signing ---

export interface ShieldSignature {
  filePath: string;       // relative to shield dir
  hash: string;           // "sha256:..."
  signedAt: string;       // ISO 8601
  signedBy: string;       // "username@opena2a-cli"
  fileSize: number;
}
...
// --- Registry Intelligence (architecture only, not implemented) ---
...
export const SHIELD_SIGNATURES_FILE = 'signatures.json';
